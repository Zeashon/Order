...
public class GoodOrderedAdapter extends RecyclerView.Adapter<GoodOrderedAdapter.ViewHolder> {
    ...
    public GoodOrderedAdapter(ShoppingCartActivity activity, SparseArray<GoodsItem> dataList) {
    ...
    public int getItemCount() {
        Log.e(TAG, "goodOrderAdpter: list.size = " + dataList.size());
        if (dataList == null) {
            return 0;
        }
