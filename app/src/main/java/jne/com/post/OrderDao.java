...
public class OrderDao {
    ...
    public void initTable() {
        ...
        try {
            ...
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20160531191902', 'Zeashon', '18659595959', '南京站','20170610','03车D1237','希望有人能帮我带一下南京的咸水鸭，我1号会坐D1234次动车经过南京','新疆大枣400g',1)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20160531192002', 'Zeashon', '18659595959', '南京站','20170609','03车D1237','希望有人能帮我带一下南京的咸水鸭，我1号会坐D1234次动车经过南京','新疆大枣400g',3)");
            ...
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20160531191476', 'Cut', '18659595959', '福州站','20170610','03车D1237','约狼人杀，在03车厢','无',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20160133414455', 'Bor', '18659595959', '杭州站','20170610','03车D1235','我有一些土特产，感兴趣可以来03车厢','无',0)");
            ...
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531431902', 'Doom', '18659595959', '西安站','20170610','03车D1237','天福茗茶 白毫银针','700',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531191907', 'Kate', '18659595959', '上海站','20170610','04车D1237','山东烟台大樱桃,特级品种,口感不好免费退货 - 150元','150元',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531191906', 'Mike', '18659595959', '南昌站','20170610','05车D1237','低价转让个大黑枸杞,一斤300元,可小刀','300元',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531191905', 'Lucy', '18659595959', '无锡站','20170610','06车D1237','希望有人能帮我带一下南京的咸水鸭，我1号会坐D1237次动车经过南京','新疆大枣400g',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531191904', 'Kitty', '18659595959', '福州站','20170610','07车D1237','经过福州想试试福州鱼丸，福州上车的朋友可否帮忙带一下哈','5',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531191903', 'Webster', '18659595959', '太原站','20170610','08车D1237','转让华为P10plus128G黑色','4500',0)");
            db.execSQL("insert into " + OrderDBHelper.TABLE_NAME + " (Id, CustomName, PhoneNum, Country,FinishTime,FinishPlace,PostDetail,Remuneration,Type) values ('20170531191919', 'Teg', '18659391659', '太原站','20170610','08车D1237','转让iPadAir2 128G白色，价格好商量','2500',0)");
